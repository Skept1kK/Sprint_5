...
class locators:
    ...
    PROFILE_PAGE_CONSTRUCTOR_LINK = (By.XPATH, ".//body//header//p[text()='Конструктор']")  # Ссылка на Конструктор на странице Личный кабинет
    ...
    MAIN_PAGE_ROLLS_CLASS = (By.XPATH, "/html/body/div/div/main/section[1]/div[1]/div[1]")
